...
RUN apt -y update
RUN apt -y install procps sudo vim git postgresql postgresql-client postgresql-13-debversion locales ftpsync iproute2 iputils-ping jdupes rsync moreutils
...
RUN mkdir /etc/dak && mkdir /srv/dak 
